...
import MarcoTulio from '../../../assets/Marco Tulio.jpg';
import GeorgeForsyth from '../../../assets/George Forsyth.png';
import GonzaloAlegria from '../../../assets/Gonzalo Alegria.jpg';
import Renzo from '../../../assets/Renzo.jpg';
import AlbertoBeingolea from '../../../assets/Alberto Beingolea.jpg';
import EnriqueOcrospoma from '../../../assets/Enrique Ocrospoma.jpg';
import SuselParedes from '../../../assets/Susel Paredes.jpg';
    ...
    <div className="h-[calc(100vh-120px)] bg-white p-6 overflow-auto">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-slate-800 mb-2">Elección de Alcalde</h1>
